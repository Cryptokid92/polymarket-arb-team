...
- Working bot on GitHub: `main` `582d66a` (PR #30). Same tree as the cloud VM hour. Second hour (no tape) exited: `list_window=66`, `list_wraps=1`, `completed_pairs=470`, `naked_incidents=0`, paper `daily_pnl=257.775`. Evidence: `docs/debug-reports/2026-08-28-paper-money-path.md`. Do not go live.
- `ALLOW_LIVE` was not created. Live trading is not enabled. No secrets committed.
